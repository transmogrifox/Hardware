...
sys = modulatorSystem(75.0, 12.5, 0.75, 3, 120000.0, 580e-6, 0.0, 80000.0, (54.0/8.0), "FLYBACK", "DCMCCM")
ss =  steadyState(sys)
ss.print_sys_params()
...
ea2 = errorAmp2z(Vref, gm, Rdc_Biasx, Ro, Rled, Rix, Rf1, Cf1, Rf2, Cf2, Cp, CTR*1.2, \
                 fc_opto, fstart, fend, npoints)
...
plot_response_w_data(ea1.f, ea1.Hc*cs.Gav*slsg.Fdg*zo.Zout, ea2.Hc*cs.Gav*slsg.Fdg*zo.Zout)
