...
\begin{figure}[H]
	...
	\caption{Peak current controller frequency response, $H_v(z)$, magnitude plots with different values of $\alpha$. }
	\label{PCM_mag_resp}
\end{figure}
...
d_{dg} = & \frac{m_d^2}{m_c^2+2m_cm_d+m_d^2}+\frac{m_c - m_d}{m_c+m_d}\nonumber\\
e_{dg} = & \frac{m_d}{m_c+m_d}-\frac{m_d^2}{m_c^2+2m_cm_d+m_d^2}\nonumber\\
f_{dg} = & \frac{T_{SW}}{2} \bigg [ \frac{m_d^2}{m_c^2+2m_cm_d+m_d^2}+\frac{mc-md}{m_c+m_d} \bigg ]m_d
\end{align*}
